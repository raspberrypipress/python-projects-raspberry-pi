...
def p1_controls():
    move = 0
    if keyboard.z or keyboard.down or p1_buttons[1].is_pressed:
        move = PLAYER_SPEED
    elif keyboard.a or keyboard.up or p1_buttons[0].is_pressed:
        move = -PLAYER_SPEED
    return move
...
def update():
    ...
    space_pressed = False
    if (keyboard.space or button_space.is_pressed) and not space_down:
        space_pressed = True
    space_down = (keyboard.space or button_space.is_pressed)
