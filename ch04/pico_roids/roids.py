...
def main():
    ...
    def explode_ship():
        ...
        if ship.counter % 2 == 0:
            ...
            tft.polygon_draw(explosion_poly, ship.x, ship.y, st7789.BLACK, 0.785398)

            tft.polygon_draw(explosion_poly, ship.x, ship.y, st7789.WHITE)

        else:

            tft.polygon_draw(explosion_poly, ship.x, ship.y, st7789.WHITE, 0.785398)

            tft.polygon_draw(explosion_poly, ship.x, ship.y, st7789.BLACK)
